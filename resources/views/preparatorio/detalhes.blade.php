                        ...
                        <div class="col-xl-12">
                            <div class="card text-center">
                                ...
                                <div class="card-footer text-muted" id="card-link">
                                    <a href="{{ url('/pre-inscricao') }}" data-toggle="pre-cadastro" data-placement="bottom" title="Faça já seu pré-cadastro para adquirir o curso!"><span class="icon-link11"></span> <strong>Aquisição & Pré-Cadastro</strong></a>
                                </div>
                            </div>
                        </div>
                    </div>
