...
Route::get('/preparatorio/agente-penitenciario', 'PreAgentePenController@index');
...
Route::get('/preparatorio/agente-penitenciario/detalhes/{id}', 'PreAgentePenController@detalhes');
